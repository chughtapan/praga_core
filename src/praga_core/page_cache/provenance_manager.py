    ...
    def _check_for_cycles(
        ...
        with self._session_factory() as session:
            ...
            if parent_relationship:
                grandparent_uri = PageURI.parse(parent_relationship.target_uri)
    ...
    def get_children(self, parent_uri: PageURI) -> List[Page]:
        ...
        with self._session_factory() as session:
            ...
            for relationship in child_relationships:
                child_uri = PageURI.parse(relationship.source_uri)
    ...
    def get_lineage(self, page_uri: PageURI) -> List[Page]:
        ...
        while current_uri and len(visited) < max_depth:
            ...
            with self._session_factory() as session:
                ...
                if parent_relationship:
                    try:
                        current_uri = PageURI.parse(parent_relationship.target_uri)
                    except Exception:
                        break
                else:
                    current_uri = None
