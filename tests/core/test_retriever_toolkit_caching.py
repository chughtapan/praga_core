...
class TestRetrieverToolkitCaching:
    ...
    def test_cache_basic_hit_and_miss(self) -> None:
    ...
    def test_cache_disabled_always_executes(self) -> None:
    ...
    def test_cache_with_complex_arguments(self) -> None:
        ...
        result2 = toolkit.complex_tool("test", limit=3, flag=True)
        assert toolkit.call_count == 1
        assert result1 == result2

        # Different args should miss cache
        result3 = toolkit.complex_tool("test", limit=3, flag=False)
        assert toolkit.call_count == 2
    ...
    def test_cache_ttl_different_durations(self) -> None:
    ...
    def test_cache_invalidator(self) -> None:
    ...
    def test_cache_with_invoke_tool(self) -> None:
        ...
        result2 = toolkit.invoke_tool("cached_tool", "test")
        assert toolkit.call_count == 1
        assert result1 == result2
...
class TestCachingEdgeCases:
    ...
    def test_cache_with_none_return(self) -> None:
        ...
        result2 = toolkit.empty_tool()

        assert toolkit.call_count == 1  # Only called once
        assert result1 == result2 == []

    def test_cache_with_exceptions(self) -> None:
        ...
        result1 = toolkit.failing_tool(False)
        result2 = toolkit.failing_tool(False)
