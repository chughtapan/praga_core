...
class TestGmailService:
    ...
    def test_create_thread_page_invalid_dates(self):
        """Test create_thread_page handles invalid date headers gracefully."""
        mock_thread = {
            "id": "thread456",
            "messages": [
                {
    ...
    def test_create_thread_page_participant_deduplication(self):
        """Test that participants are properly deduplicated across messages."""
        mock_thread = {
            "id": "thread456",
            "messages": [
                {
        ...
        self.mock_api_client.get_thread.return_value = mock_thread
        self.service.parser.extract_body = Mock(return_value="Participant test body")
