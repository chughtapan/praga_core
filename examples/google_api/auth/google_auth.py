...
class GoogleAuthManager:
    ...
    def __new__(cls, credentials_file: str = "", token_file: str = ""):
    ...
    def __init__(self, credentials_file: str = "", token_file: str = ""):
        ...
        self.credentials_file = credentials_file or config.GOOGLE_CREDENTIALS_PATH
        self.token_file = token_file or config.GOOGLE_TOKEN_PATH
        self._creds = None
